...
<Lab key="12" order="12" date="9.1." plan>
    <p>Algoritmizace + programování: základní grafové algoritmy &ndash; BFS, DFS (pokud bude čas, tak navíc i Dijkstrův algoritmus a A*), <Link href="NPRG062/12">úlohy na procvičení</Link> &ndash; Cesta králem na šachovnici, Nejkratší cesta v ohodnoceném grafu, Bipartitní grafy (<LabPrograms source="lab" order="12"/>).</p>
</Lab>,
]
