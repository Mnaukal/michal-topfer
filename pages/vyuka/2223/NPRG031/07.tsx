...
export default function CourseLab() {
  return (<>
    ...
    <h1>Programování 2 &ndash; 7. cvičení</h1>

    <p>Úlohy k procvičení. U všech úloh doporučuji začít tím, že si rozmyslíte signaturu funkce (parametry, jejich typy, jejich typové parametry, návratovou hodnotu).</p>
