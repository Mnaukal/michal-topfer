...
export default function CourseIndex() {
  return (<>
    ...
    <h1>Cvičení NPRG062 &ndash; Algoritmizace (ZS 2021/22)</h1>

    <p className="lead">Pondělí 15:40, N8</p>

    <CardBorderPrimary>
      Cvičení probíhá v jednom bloku s cvičením z Programování 1. Předměty Algoritmizace a Programování 1 jsou úzce spojené, takže je reálně budeme chápat jako jedno dlouhé cvičení. Další podrobnosti a přehled probrané látky najdete na stránce <Link href="NPRG030">Cvičení NPRG030 &ndash; Programování 1</Link>.
    </CardBorderPrimary>
    ...
    <p><a href="https://ksvi.mff.cuni.cz/~topfer/">Stránky doc. Pavla Töpfera</a></p>
